\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md200}{}\doxysection{What Is g\+Mock?}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md200}
...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md201}{}\doxysection{Why g\+Mock?}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md201}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md202}{}\doxysection{Getting Started}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md202}
g\+Mock is bundled with googletest.\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md203}{}\doxysection{A Case for Mock Turtles}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md203}
...
You don\textquotesingle{}t need to define these mock methods somewhere else -\/ the {\ttfamily M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+OD} macro will generate the definitions for you. It\textquotesingle{}s that simple!\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md206}{}\doxysubsection{Where to Put It}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md206}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using g\+Mock. However, as we shall reveal soon, g\+Mock allows you to do {\itshape so much more} with the mocks.\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md208}{}\doxysection{Setting Expectations}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md208}
...
right.\char`\"{}\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md209}{}\doxysubsection{General Syntax}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md209}
...
This works for all non-\/overloaded methods; if a method is overloaded, you need to help g\+Mock resolve which overload is expected by specifying the number of arguments and possibly also the \href{gmock_cook_book.md\#SelectOverload}{\texttt{ types of the arguments}}.\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md211}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_autotoc_md211}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! The details can be found \href{gmock_cook_book.md\#OrderedCalls}{\texttt{ here}}.)\hypertarget{md_build__deps_googletest-src_docs_gmock_for_dummies_StickyExpectations}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_build__deps_googletest-src_docs_gmock_for_dummies_StickyExpectations}
