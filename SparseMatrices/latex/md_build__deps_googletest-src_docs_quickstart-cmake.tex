This tutorial aims to get you up and running with Google\+Test using C\+Make. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point. If your project uses Bazel, see the Quickstart for Bazel instead.\hypertarget{md_build__deps_googletest-src_docs_quickstart-cmake_autotoc_md239}{}\doxysection{Prerequisites}\label{md_build__deps_googletest-src_docs_quickstart-cmake_autotoc_md239}
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_build__deps_googletest-src_docs_quickstart-cmake_autotoc_md240}{}\doxysection{Set up a project}\label{md_build__deps_googletest-src_docs_quickstart-cmake_autotoc_md240}
...
For more information about how to create {\ttfamily C\+Make\+Lists.\+txt} files, see the \href{https://cmake.org/cmake/help/latest/guide/tutorial/index.html}{\texttt{ C\+Make Tutorial}}.\hypertarget{md_build__deps_googletest-src_docs_quickstart-cmake_autotoc_md241}{}\doxysection{Create and run a binary}\label{md_build__deps_googletest-src_docs_quickstart-cmake_autotoc_md241}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_build__deps_googletest-src_docs_quickstart-cmake_autotoc_md242}{}\doxysection{Next steps}\label{md_build__deps_googletest-src_docs_quickstart-cmake_autotoc_md242}
