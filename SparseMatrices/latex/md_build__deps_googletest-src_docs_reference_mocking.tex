This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, include the header {\ttfamily \mbox{\hyperlink{gmock_8h_source}{gmock/gmock.\+h}}}.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_macros}{}\doxysection{Macros}\label{md_build__deps_googletest-src_docs_reference_mocking_macros}
Google\+Test defines the following macros for working with mocks.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_MOCK_METHOD}{}\doxysubsection{M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+OD}\label{md_build__deps_googletest-src_docs_reference_mocking_MOCK_METHOD}
...
{\ttfamily M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+OD} must be used in the {\ttfamily public\+:} section of a mock class definition, regardless of whether the method being mocked is {\ttfamily public}, {\ttfamily protected}, or {\ttfamily private} in the base class.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_EXPECT_CALL}{}\doxysubsection{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL}\label{md_build__deps_googletest-src_docs_reference_mocking_EXPECT_CALL}
...
See details for each modifier clause below.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md263}{}\doxysubsubsection{With \{\#\+E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L.\+With\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md263}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md264}{}\doxysubsubsection{Times \{\#\+E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L.\+Times\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md264}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md265}{}\doxysubsubsection{In\+Sequence \{\#\+E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L.\+In\+Sequence\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md265}
...
See also the \href{\#InSequence}{\texttt{ {\ttfamily In\+Sequence} class}}.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md266}{}\doxysubsubsection{After \{\#\+E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L.\+After\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md266}
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md267}{}\doxysubsubsection{Will\+Once \{\#\+E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L.\+Will\+Once\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md267}
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md268}{}\doxysubsubsection{Will\+Repeatedly \{\#\+E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L.\+Will\+Repeatedly\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md268}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md269}{}\doxysubsubsection{Retires\+On\+Saturation \{\#\+E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L.\+Retires\+On\+Saturation\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md269}
...
The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_ON_CALL}{}\doxysubsection{O\+N\+\_\+\+C\+A\+LL}\label{md_build__deps_googletest-src_docs_reference_mocking_ON_CALL}
...
See details for each modifier clause below.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md270}{}\doxysubsubsection{With \{\#\+O\+N\+\_\+\+C\+A\+L\+L.\+With\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md270}
{\ttfamily .With(}$\ast${\ttfamily multi\+\_\+argument\+\_\+matcher}$\ast${\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily O\+N\+\_\+\+C\+A\+LL} statement.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md271}{}\doxysubsubsection{Will\+By\+Default \{\#\+O\+N\+\_\+\+C\+A\+L\+L.\+Will\+By\+Default\}}\label{md_build__deps_googletest-src_docs_reference_mocking_autotoc_md271}
...
The {\ttfamily Will\+By\+Default} clause must be used exactly once with each {\ttfamily O\+N\+\_\+\+C\+A\+LL} statement.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_classes}{}\doxysection{Classes}\label{md_build__deps_googletest-src_docs_reference_mocking_classes}
Google\+Test defines the following classes for working with mocks.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_build__deps_googletest-src_docs_reference_mocking_DefaultValue}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_NiceMock}{}\doxysubsection{Nice\+Mock}\label{md_build__deps_googletest-src_docs_reference_mocking_NiceMock}
...
{\ttfamily Nice\+Mock$<$T$>$} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_NaggyMock}{}\doxysubsection{Naggy\+Mock}\label{md_build__deps_googletest-src_docs_reference_mocking_NaggyMock}
...
\mbox{\hyperlink{classMock}{Mock}} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock$<$T$>$}.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_StrictMock}{}\doxysubsection{Strict\+Mock}\label{md_build__deps_googletest-src_docs_reference_mocking_StrictMock}
...
{\ttfamily Strict\+Mock$<$T$>$} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_Sequence}{}\doxysubsection{Sequence}\label{md_build__deps_googletest-src_docs_reference_mocking_Sequence}
{\ttfamily \+::testing\+::\+Sequence}

Represents a chronological sequence of expectations. See the \href{\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence}}} clause of {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL} for usage.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_InSequence}{}\doxysubsection{In\+Sequence}\label{md_build__deps_googletest-src_docs_reference_mocking_InSequence}
...
The name of the {\ttfamily In\+Sequence} object does not matter.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_Expectation}{}\doxysubsection{Expectation}\label{md_build__deps_googletest-src_docs_reference_mocking_Expectation}
...
Useful for specifying sequences of expectations; see the \href{\#EXPECT_CALL.After}{\texttt{ {\ttfamily After}}} clause of {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL}.\hypertarget{md_build__deps_googletest-src_docs_reference_mocking_ExpectationSet}{}\doxysubsection{Expectation\+Set}\label{md_build__deps_googletest-src_docs_reference_mocking_ExpectationSet}
