\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md225}{}\doxysection{Introduction\+: Why googletest?}\label{md_build__deps_googletest-src_docs_primer_autotoc_md225}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md227}{}\doxysection{Basic Concepts}\label{md_build__deps_googletest-src_docs_primer_autotoc_md227}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md228}{}\doxysection{Assertions}\label{md_build__deps_googletest-src_docs_primer_autotoc_md228}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest-src_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_build__deps_googletest-src_docs_primer_same-data-multiple-tests}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md230}{}\doxysection{Invoking the Tests}\label{md_build__deps_googletest-src_docs_primer_autotoc_md230}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md231}{}\doxysection{Writing the main() Function}\label{md_build__deps_googletest-src_docs_primer_autotoc_md231}
...
\{\+: .callout .note\} N\+O\+TE\+: {\ttfamily Parse\+G\+Unit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_build__deps_googletest-src_docs_primer_autotoc_md232}{}\doxysection{Known Limitations}\label{md_build__deps_googletest-src_docs_primer_autotoc_md232}
