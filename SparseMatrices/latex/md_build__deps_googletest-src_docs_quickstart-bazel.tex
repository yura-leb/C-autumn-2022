This tutorial aims to get you up and running with Google\+Test using the Bazel build system. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point.\hypertarget{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md234}{}\doxysection{Prerequisites}\label{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md234}
...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md236}{}\doxysection{Create and run a binary}\label{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md236}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md237}{}\doxysection{Next steps}\label{md_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md237}
